...
class HospitalModel(db.Model):
    ...
    # hospital_psychologists = db.relationship('HospitalPsychologistModel', backref='hospital', lazy='dynamic', uselist=True)
    ...
    def json(self):
        ...
        #  'hopital_psychologists': [hopital_psychologist.json() for hopital_psychologist in self.hopital_psychologists.all()]
