...
api.add_resource(Register, '/register-psychologist')
api.add_resource(Edit, '/edit-psychologist/<string:crp>')
api.add_resource(DeleteUser, '/delete-psychologist/<int:id>')
api.add_resource(ShowInformationUserID, '/psychologist-information/<string:crp>')
